...
Route::middleware('student')->group(function(){    
    ...
    Route::post('student/proposal',[StudentController::class,'showProposal'])->name('student.proposal');
    Route::get('student/proposal/{pid}',[StudentController::class,'viewProposal'])
        ->whereNumber('pid')
...
Route::get('/lecturer/view_student/{id}', [LecturerController::class, 'viewstudent'])->name('lecturer.view_student');
