...
<body >
    ...
    {{-- <div class="d-flex justify-content-center">
        <div class="col-sm-4" style="margin-top:220px;margin-left:870px;">
                    ...
                    <div style=" letter-spacing:2px;padding:2px;text-transform:capitalize;font-weight:bold;"><h4 class="text-center text-info mt-4 "style="font-weight:bolder;">Supervisor Authentication</h4></div>
