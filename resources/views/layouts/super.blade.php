...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" >
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.dashboard') }}">
            ...
            <div class="sidebar-brand-text mx-3">@if(auth()->guard('super')->check())ADMIN @endif</div>
        </a>
        ...
        @if(auth()->guard('super')->check())
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('super.addProjectCord') }}" >
                    <i class="fa fa-plus"></i>
                    <span style="font-size:14px;">Project Coordinator</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('super/viewProjectCord') }}" >
                    <i class="fa fa-eye"></i>
                    <span style="font-size:14px;">Project Coordinator</span>
                </a>
            </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content" style="background-color:dark;">
            ...
            <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-2 static-top">
                ...
                @if(auth()->guard('super')->check())
                            <form action="{{route('super.logout')}}" id="formLogout" method="post">@csrf</form>
