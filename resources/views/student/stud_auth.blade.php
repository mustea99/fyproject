...
<body >
  <div class="text-center "><img src="{{ asset('assets\img\logo\buk.png') }}" width="150px" height="150px"></div>
                    <div style="letter-spacing:2px;padding:2px;text-transform:capitalize;font-weight:bold;"><h4 class="text-center text-info mt-4"style="font-weight:bolder;">Student Authentication</h4></div>
